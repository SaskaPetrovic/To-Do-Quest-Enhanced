...
Task.create!(title: "Moving the couch", description: "Move the couch from the living room to the bedroom", status: "not_started", urgence: "high", time: Time.now , rewards: "100xp", user: user, sub_category: rogue1)
Task.create!(title: "Planting flowers", description: "Plant flowers in the garden", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: rogue2)
Task.create!(title: "Cleaning the attic", description: "Clean the attic and organize the items", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: rogue3)
Task.create!(title: "Fixing the leaky faucet", description: "Fix the leaky faucet in the kitchen", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: rogue4)
Task.create!(title: "Buying groceries", description: "Go to the supermarket and buy groceries for the week", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: rogue5)

Task.create!(title: "Answering emails", description: "Answer all the emails in the inbox", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: mage1)
Task.create!(title: "Finishing an essay", description: "Write an essay on a topic of your choice", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: mage2)
Task.create!(title: "Preparing a presentation", description: "Prepare a presentation for a meeting", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: mage3)
Task.create!(title: "Updating the project plan", description: "Update the project plan with the latest information", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: mage4)
Task.create!(title: "Writing a report", description: "Write a report on the progress of the project", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: mage5)

Task.create!(title: "Watching a movie", description: "Watch a movie of your choice", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: ranger1)
Task.create!(title: "Reading a book", description: "Read a book from the library", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: ranger2)
Task.create!(title: "Playing a game", description: "Play a game on the console", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: ranger3)
Task.create!(title: "Calling a family member", description: "Call a family member to catch up", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: ranger4)
Task.create!(title: "Hanging out with friends", description: "Hang out with friends at the local cafe", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: ranger5)

Task.create!(title: "Taking a walk", description: "Go for a walk in the park", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: knight1)
Task.create!(title: "Doing a workout routine", description: "Follow a workout routine at home", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: knight2)
Task.create!(title: "Stretching exercises", description: "Do stretching exercises to improve flexibility", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: knight3)
Task.create!(title: "Preparing a healthy meal", description: "Cook a healthy meal for dinner", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: knight4)
Task.create!(title: "Drinking enough water", description: "Drink 8 glasses of water throughout the day", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: knight5)

Task.create!(title: "Setting personal goals", description: "Set personal goals for the week", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: bard1)
Task.create!(title: "Reflecting on the day", description: "Reflect on the events of the day before going to bed", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: bard2)
Task.create!(title: "Practicing a hobby", description: "Spend an hour practicing a hobby you enjoy", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: bard3)
Task.create!(title: "Journaling", description: "Write in your journal about your thoughts and feelings", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: bard4)
Task.create!(title: "Planning the week ahead", description: "Plan the tasks and goals for the upcoming week", status: "not_started", urgence: "high", time: Time.now, rewards: "100xp", user: user, sub_category: bard5)
